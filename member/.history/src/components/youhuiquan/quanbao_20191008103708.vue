            ...
            <div class="item">
              <van-row type="flex" justify="space-between">
                ...
                item.ApplicableType=='通用'?'son1':item.ApplicableType=='商品品牌'?'son2':item.ApplicableType=='商品信息'?'son3':'son4']"
                  ...
                  <span v-if="item.UseType == 0" class="Symbol" :class="['son',
                item.ApplicableType=='通用'?'son1':item.ApplicableType=='商品品牌'?'son2':item.ApplicableType=='商品信息'?'son3':'son4']">￥</span>
                  <span v-else>折</span>
                </van-col>
                <van-col span="14">
                  <div class="right">
              ...
              <van-row type="flex" justify="space-between" align="center" class="bottom">
                <van-col span="6" style="margin-left:0.42rem;">
                  <i class="iconfont iconweibiaoti--1" :class="['son',
                item.ApplicableType=='通用'?'son1':item.ApplicableType=='商品品牌'?'son2':item.ApplicableType=='商品信息'?'son3':'son4']" v-if="item.ApplicableType=='通用'"></i>
                  <i class="iconfont iconweibiaoti--1" :class="['son',
                item.ApplicableType=='通用'?'son1':item.ApplicableType=='商品品牌'?'son2':item.ApplicableType=='商品信息'?'son3':'son4']" v-if="item.ApplicableType=='商品类别'"></i>
                  <i class="iconfont iconweibiaoti--1" :class="['son',
                item.ApplicableType=='通用'?'son1':item.ApplicableType=='商品品牌'?'son2':item.ApplicableType=='商品信息'?'son3':'son4']" v-if="item.ApplicableType=='商品信息'"></i>
                  <i class="iconfont iconweibiaoti--1" :class="['son',
                item.ApplicableType=='通用'?'son1':item.ApplicableType=='商品品牌'?'son2':item.ApplicableType=='商品信息'?'son3':'son4']" v-if="item.ApplicableType=='商品品牌'"></i>
                  ...
                  <span
                    style="vertical-align:middle;color:#999;font-weight:6rem;"
