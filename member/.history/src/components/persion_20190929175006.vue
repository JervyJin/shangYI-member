    ...
    <div class="banner">
      ...
      <p>
        ...
        <router-link to="/jifen" tag="span">
            <p>
          <img class="icon bg-1" src="../assets/images/jifen.png" alt />
...
export default {
  ...
  created() {
    this.http.get("/api/services/app/CRMMemberService/GetMyInfo", {
        params: {}
      }).then((response) => {
  ...
  methods: {
    ...
    memberUntying() {
      Dialog.confirm({
        ...
        this.http.post('/api/services/app/CRMMemberMyInfoService/WeChatUnBound').then(res => {
