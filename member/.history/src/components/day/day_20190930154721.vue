...
/deep/ {
  ...
  .van-row--justify-space-between::before {
    content: '';                 /*CSS伪类用法*/
            ...
            height: 2px;
————————————————
版权声明：本文为CSDN博主「呼呼伙伴」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/baidu_33163851/article/details/51304347
  }
