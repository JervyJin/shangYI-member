    ...
    <div class="banner">
      <div class="min">
        <router-link to="/huiyuanxinxi">
          ...
          <i class="iconfont iconwodemingpian"></i>
          <p>我的名片</p>
        </router-link>
        ...
        <router-link to="/congzi">
          ...
          <i class="iconfont iconchongzhi"></i>
          <p>在线充值</p>
        </router-link>
      ...
      <!-- 常用功能 -->
      <p style="padding:0.2rem 0.1rem;font-size: 0.24rem;color:#333;font-weight: 6rem;">常用功能</p>
...
.iconwodemingpian {
  ...
  color: #da6d97;
  font-weight: initial;
  // background: rgba(218, 109, 151, 0.97);
}
.iconqrcode {
  display: block;
  margin-top: 0.25rem;
