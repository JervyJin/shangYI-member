<template>
  <div>
    ...
    <div class="banner">
      ...
      <!-- 常用功能 -->
      <p style="padding:0.1rem;font-size: 0.25rem;color:#333;font-weight: bold;">常用功能</p>
...
export default {
  ...
  created() {
    ...
    /*领红包*/
// debugger
    if (this.$router.currentRoute.query && this.$router.currentRoute.query.refer === "scanredbox") {
